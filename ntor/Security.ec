...
+ proc; inline.
  ...
  sp 3 1; if => //. smt().
  + sp 2 2; if => //. 
    + auto => /> &1 &2 3? m *. do split; 5,10..12,14: smt(mem_set get_setE loggK expgK expM in_fsetU1). 
move => x *.
...
admit. admit. admit. admit. admit. admit. admit. admit. (* all the same issue *)
move => b.
case (b = g ^ y_m{1}) => beq.
+ rewrite mem_set beq //=.
  rewrite in_fsetU1 //=.
