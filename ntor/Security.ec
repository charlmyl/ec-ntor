...
module (Red_Eph (A : A_GAKE_nodhs) : St_CDH_A) (O : Oracle) = {
  module Red_O : GAKE_nodhs_i = Game4Eph with {
    ...
    proc init_mem [
      -1 + {tags_opt <- empty; h1m_opt <- empty; h2m_opt <- empty; count_j <- 0; j_inst <- empty; count_i <- 0; i_inst <- empty;}
    ]
...
lemma sofar2 &m: `| Pr[E_GAKE_nodhs(GAKEb_nodhs(NTOR_S_mod, NTOR_C_mod, RO), A).run(false) @ &m : res] - Pr[E_GAKE_nodhs(GAKEb_nodhs(NTOR_S_mod, NTOR_C_mod, RO), A).run(true) @ &m : res]|
  <= Pr[E_GAKE_nodhs(Game4Eph, A).run(true) @ &m : Game4Eph.badq] + Pr[E_GAKE_nodhs(Game4Ltk, A).run(true) @ &m : Game4Ltk.badq]
       + Pr[E_GAKE_nodhs(Game1, A).run(false) @ &m : Game1.bad2] + Pr[E_GAKE_nodhs(Game1, A).run(true) @ &m : Game1.bad2] + 2%r * ((q_is + q_m1 + q_m2) ^ 2)%r * mu1 dt (mode dt).
proof. 
rewrite !(gake_game0 _).
apply (ler_trans (`|Pr[E_GAKE_nodhs(Game1, A).run(false) @ &m : res] - Pr[E_GAKE_nodhs(Game1, A).run(true) @ &m : res]| + 2%r * ((q_is + q_m1 + q_m2) ^ 2)%r * mu1 dt (mode dt))).
...
local op clear_esk_s (s : pr_st_server instance_state) = 
match s with 
...
call (: Game4Eph.badq,
        ={b0, hm, tested, servers, b_set, x_set, y_set, pk_set, m1_set, m2_set, bad1, bad2, test_ephrev_s, test_ltkrev}(Red_Eph.Red_O, Game4Eph)
         ...
         /\ (Game4Eph.test_ltkrev{2} => Game4Eph.tested{2} <> None)
         ...
         /\ (forall bj, omap clear_esk_s Game4Eph.s_smap{2}.[bj] = Red_Eph.Red_O.s_smap{1}.[bj])
         /\ (forall i, omap clear_esk Game4Eph.c_smap{2}.[i] = Red_Eph.Red_O.c_smap{1}.[i])
         ...
         /\ (forall i st pt ir, i \in Game4Eph.c_smap{2} => Game4Eph.c_smap{2}.[i] = Some (Pending_mod st pt ir)
              => pt.`2 = g ^ st.`2 /\ pt.`2 \in Game4Eph.m1_set{2} /\ pt.`1 = st.`1 /\ pt.`1 \in Game4Eph.servers{2} 
         ...
         /\ (forall i st t k ir, i \in Game4Eph.c_smap{2} => Game4Eph.c_smap{2}.[i] = Some (Accepted_mod st t k ir)
              => t.`1.`2 = g ^ st.`2 /\ t.`1.`2 \in Game4Eph.m1_set{2} /\ t.`1.`1 = st.`1 /\ st.`1 \in Game4Eph.servers{2} 
                      /\ ((oget t.`2).`1 \in Game4Eph.m2_set{2} \/ (oget t.`2).`1 \in Game4Eph.y_set{2})
                      /\ i \in Red_Eph.Red_O.i_inst{1} /\ (oget Red_Eph.Red_O.i_inst{1}.[i] \in St_CDH_O.x_map{1}) 
                      /\ st.`2 = oget St_CDH_O.x_map{1}.[(oget Red_Eph.Red_O.i_inst{1}.[i])]
                      /\ (ir.`1 <=> (oget Red_Eph.Red_O.i_inst{1}.[i]) \in St_CDH_O.cr1{1})
                      /\ t.`2 <> None /\ ((oget t.`2).`1 ^ st.`2, st.`1 ^ st.`2, st.`1, g ^ st.`2, (oget t.`2).`1) \in Game4Eph.h1m{2}
                      /\ (oget t.`2).`2 = oget Game4Eph.h1m{2}.[((oget t.`2).`1 ^ st.`2, st.`1 ^ st.`2, st.`1, g ^ st.`2, (oget t.`2).`1)])
         /\ (forall bj st t k ir, bj \in Game4Eph.s_smap{2} => Game4Eph.s_smap{2}.[bj] = Some (Accepted_mod st t k ir)
              ...
              => t.`1.`1 = g ^ st.`1 /\ (g ^ st.`1) \in Game4Eph.servers{2} /\ g ^ st.`1 = bj.`1
                      /\ t.`2 <> None /\ st.`2 <> None /\ g ^ (oget st.`2) = (oget t.`2).`1
                      /\ g ^ (oget st.`2) \in Game4Eph.m2_set{2} /\ g ^ (oget st.`2) \notin Game4Eph.servers{2}
                      /\ (t.`1.`2 \in Game4Eph.m1_set{2} \/ t.`1.`2 \in Game4Eph.x_set{2})
                      /\ g ^ st.`1 \notin Game4Eph.m2_set{2}
                      ...
                      /\ ((t.`1).`2 ^ (oget st.`2), (t.`1).`2 ^ st.`1, g ^ st.`1, (t.`1).`2, g ^ (oget st.`2)) \in Game4Eph.h1m{2}
                      /\ (oget t.`2).`2 = oget Game4Eph.h1m{2}.[((t.`1).`2 ^ (oget st.`2), (t.`1).`2 ^ st.`1, g ^ st.`1, (t.`1).`2, g ^ (oget st.`2))])
         ...
         /\ (forall i, i \in Game4Eph.c_smap{2} => get_ir_test (oget Game4Eph.c_smap{2}.[i]) => !Game4Eph.bad1{2} => !Game4Eph.bad2{2}
              => (oget (oget (get_trace (oget Game4Eph.c_smap{2}.[i]))).`2).`1 \in Game4Eph.m2_set{2}
              => (exists bj, bj \in Game4Eph.s_smap{2} /\ get_trace (oget Game4Eph.s_smap{2}.[bj]) = get_trace (oget Game4Eph.c_smap{2}.[i])))
         /\ (forall i, i \in Game4Eph.c_smap{2} => get_ir_test (oget Game4Eph.c_smap{2}.[i]) 
              => (exists st t k ir, Game4Eph.c_smap{2}.[i] = Some (Accepted_mod st t k ir)))
         /\ (forall bj, bj \in Game4Eph.s_smap{2} => (exists st t k ir, Game4Eph.s_smap{2}.[bj] = Some (Accepted_mod st t k ir)))
       , St_CDH_O.win{1}); last first.

auto => />.
split. do split; smt(emptyE mem_empty in_fset0).
move => inv1 inv2 inv3 inv4 inv5 inv6 inv7 inv8 inv9 inv10 inv11 inv12 inv13 inv14 inv15 inv16 inv17 inv18 inv19 inv20 inv21 inv22 inv23 inv24 inv25 inv26 inv27 inv28 inv29 inv30 inv31 inv32 inv33 inv34 inv35 inv36 inv37 inv38 inv39 inv40 inv41 inv42 inv43 inv44 inv45 inv46 inv47 inv48 inv49 inv50 inv51 inv52 inv53 inv54 inv55 inv56 inv57 inv58 inv59 inv60 inv61 inv62 inv63 inv64 inv65 inv66 inv67 inv68 rl rr al bl b1l b2l h1l h2l pksl m1l m2l tel tll tl xsl ysl wl ar br b1r b2r bqr h1r h2r hqr pksr m1r m2r tlr tr tqr xsr ysr.
by case : (!ar) => />.
    ...
    + if {1} => //. admit. (*
            ...
            + sp; seq 1 1: (#pre /\ ={t}). auto => />.
              ...
              + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
                ...
                + rcondf {1} ^if. auto => /#.
                  ...
                  auto => /> &1 &2 45? inv *. do split; smt(mem_set get_setE in_fsetU1 expgK expM).
                rcondf {1} ^if. auto => /#.
                rcondf {2} ^if. auto => /#.
                rcondf {1} ^if{2}. auto => /#.
                rcondf {2} ^if{2}. auto => /#.
              ...
              sp 1 1; if => //.
              + auto => /> &1 &2 *.
              auto => /> &1 &2 58? c1 *. clear c1. do split; smt(mem_set get_setE in_fsetU1 expgK expM). 
            sp; seq 1 1: (#pre /\ ={t}). auto => />.
            if => //. auto => /> &1 &2 *. smt(expgK expM).
            + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
              if => //. smt(expgK expM).
          ...
          + sp; seq 1 1: (#pre /\ ={t}). auto => />.
            ...
            + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
              ...
              + rcondf {1} ^if. auto => /#.
                ...
                auto => /> &1 &2 44? inv *. do split; ~25: smt(mem_set get_setE expgK expM in_fsetU1).
                move => i3 st t0 k0 ir.
                have := inv i3 st t0 k0 ir.
                smt(get_setE in_fsetU1 mem_set).
              rcondf {1} ^if. auto => /#.
              rcondf {2} ^if. auto => /#.
              rcondf {1} ^if{2}. auto => /#.
              ...
              sp 1 1; if => //.
              + auto => /> &1 &2 *.
              auto => /> &1 &2 42? inv *. do split; smt(mem_set get_setE in_fsetU1 expgK expM).
            seq 1 1: (#pre /\ ={k}). auto => />.
            if => //. smt(expgK expM).
            + rcondf {1} ^if. auto => /#.
              rcondf {2} ^if. auto => /#.
            ...
            sp 1 1; if => //.
            + auto => /> &1 &2 *.
            auto => /> &1 &2 58? c1 *. clear c1. smt(expgK expM loggK in_fsetU1).
          sp; seq 1 1: (#pre /\ ={t}). auto => />.
          if => //. auto => /> &1 &2 *. smt(expgK expM).
          + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
            if => //. smt(expgK expM).
      ...
      + if {1} => //. 
        + rcondt {1} ^if. auto => /#.
          ...
          + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
            ...
            + rcondf {1} ^if. auto => /#.
              ...
              sp 2 2; if => //. 
              + auto => /> *. do split; smt(mem_set get_setE expgK expM in_fsetU1).
              auto => /> &1 &2 46? inv *. do split; smt(mem_set get_setE in_fsetU1 expgK expM).
         (* this was number 27     move => i3 st t0 k0 ir.
              have := inv i3 st t0 k0 ir.
              smt(get_setE in_fsetU1 mem_set).*)
            rcondf {1} ^if. auto => /#.
            rcondf {2} ^if. auto => /#.
            ...
            sp 1 1; if => //.
            + auto => /> &1 &2 *. do split; smt(mem_set get_setE expgK expM).
            auto => /> &1 &2 59? c1 *. clear c1. do split; smt(mem_set get_setE expgK expM in_fsetU1).
          seq 1 1: (#pre /\ ={k}). auto => />.
          if => //. smt(expgK expM loggK).
          + rcondf {1} ^if. auto => /#.
            rcondf {2} ^if. auto => /#.
        ...
        + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
          ...
          auto => /> &1 &2 *. split. smt(loggK in_fsetU1). move => *. do split; smt(mem_set get_setE expgK expM in_fsetU1).
        seq 1 1: (#pre /\ ={k}). auto => />.
        if => //. smt(expgK expM).
        + rcondf {1} ^if. auto => /#.
          rcondf {2} ^if. auto => /#.
        ...
        auto => /> &1 &2 *. split. smt(loggK in_fsetU1). smt(expgK expM loggK in_fsetU1).
      ...
      + if {1} => //.
        + rcondt {1} ^if. auto => /#.
          ...
          + rcondf {1} ^if. auto => /#.
            ...
            rcondf {2} ^if{2}. auto => /#.
            sp 2 2; if => //. 
            + auto => /> &1 &2 *. do split; smt(mem_set get_setE expgK expM loggK). 
            auto => /> &1 &2 *. do split; smt(mem_set get_setE expgK expM loggK in_fsetU1).
          rcondf {1} ^if. auto => /#.
          rcondf {2} ^if. auto => /#.
          rcondf {1} ^if{2}. auto => /#.
        ...
        + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
          ...
          + rcondf {1} ^if. auto => /#.
            ...
            sp 2 2; if => //.
            + sp 1 1; if => //.
              + auto => /> *. do split; smt(mem_set get_setE expgK expM loggK). 
              auto => /> *. do split; smt(mem_set get_setE expgK expM loggK in_fsetU1).
            if => //.
            + auto => /> *. do split; smt(mem_set get_setE expgK expM loggK in_fsetU1).
            auto => /> *. do split; smt(mem_set get_setE expgK expM loggK in_fsetU1).
...
+ proc; inline. admit. (*
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 str stl 30? inv inv2 *.
      ...
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2}) Game4Eph.s_smap{2})) 
        = (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{1}) Red_Eph.Red_O.s_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        move : str stl inv inv2. clear. smt().
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2} /\ get_ir_test val = false) Game4Eph.s_smap{2})) 
                 = (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
               get_trace val = Some t'{1} /\ get_ir_test val = false) Red_Eph.Red_O.s_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        move : str stl inv inv2. clear. smt().
...
+ proc; inline.
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 str stl 30? inv inv2 *.
      rewrite /untested_partner_s.
      rewrite /get_partners_s /get_untested_partners_s.
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t'{2}) Game4Eph.c_smap{2})) = (fdom
                (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t'{1}) Red_Eph.Red_O.c_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        move : str stl inv inv2. clear. smt().
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t'{2} /\ get_ir_test val = false)
                 Game4Eph.c_smap{2})) = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
               get_trace val = Some t'{1} /\ get_ir_test val = false) Red_Eph.Red_O.c_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        move : str stl inv inv2. clear. smt().
...
+ proc; inline.
  ...
  + match Honest_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 30? inv inv2 *. 
      split.
      + move => + ntpp.
        have->: ! tested_pot_partner_c b{2} Game4Eph.c_smap{2} Game4Eph.s_smap{2}.
        have := ntpp.
        rewrite /tested_pot_partner_c.
        rewrite /get_tested_pot_partner_c.
        have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => (exists (m1o : pkey) (m2o : (pkey * tag) option),
                 get_trace val = Some ((b{2}, m1o), m2o)) /\ get_ir_test val = true /\ forall (j0 : int), (b{2}, j0) \in Red_Eph.Red_O.s_smap{1} =>
                get_trace (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j0]) <> get_trace val) Red_Eph.Red_O.c_smap{1})) = (fdom (filter 
               (fun (_ : int) (val : pr_st_client instance_state) => (exists (m1o : pkey) (m2o : (pkey * tag) option),
                get_trace val = Some ((b{2}, m1o), m2o)) /\  get_ir_test val = true /\ forall (j0 : int),
               (b{2}, j0) \in Game4Eph.s_smap{2} => get_trace (oget Game4Eph.s_smap{2}.[b{2}, j0]) <> get_trace val) Game4Eph.c_smap{2})).
        + rewrite fsetP.
          move => x.
          rewrite !mem_fdom !mem_filter //=.
          move : inv inv2. clear. smt().
        smt().
      simplify.
      move => + j pkin - /(_ j).
      have : (b{2}, j) \in Red_Eph.Red_O.s_smap{1}  by smt().
      move => bjin //=.
      rewrite /untested_partner_s.
      rewrite /get_partners_s /get_untested_partners_s.
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                       get_trace val = Some (oget (get_trace (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j])))) Red_Eph.Red_O.c_smap{1})) = (fdom
                (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                      get_trace val = Some (oget (get_trace (oget Game4Eph.s_smap{2}.[b{2}, j])))) Game4Eph.c_smap{2})).
      + rewrite fsetP.
        move => x.
        rewrite !mem_fdom !mem_filter //=.
        move : str stl inv inv2. clear. smt().
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                      get_trace val = Some (oget (get_trace (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j]))) /\
                      get_ir_test val = false) Red_Eph.Red_O.c_smap{1})) = (fdom (filter
                  (fun (_ : int) (val : pr_st_client instance_state) =>
                     get_trace val = Some (oget (get_trace (oget Game4Eph.s_smap{2}.[b{2}, j]))) /\
                     get_ir_test val = false) Game4Eph.c_smap{2})).
      + rewrite fsetP.
        move => x.
        rewrite !mem_fdom !mem_filter //=. 
        move : str stl inv inv2. clear. move => *. split; smt().
      smt().
    move => + ntpp.
    have->: ! tested_pot_partner_c b{2} Red_Eph.Red_O.c_smap{1} Red_Eph.Red_O.s_smap{1}.
    + have := ntpp.
      rewrite /tested_pot_partner_c.
      rewrite /get_tested_pot_partner_c.
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
              (exists (m1o : pkey) (m2o : (pkey * tag) option), get_trace val = Some ((b{2}, m1o), m2o)) /\
              get_ir_test val = true /\ forall (j0 : int), (b{2}, j0) \in Red_Eph.Red_O.s_smap{1} =>
                get_trace (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j0]) <>
                get_trace val) Red_Eph.Red_O.c_smap{1})) = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
             (exists (m1o : pkey) (m2o : (pkey * tag) option), get_trace val = Some ((b{2}, m1o), m2o)) /\
             get_ir_test val = true /\ forall (j0 : int), (b{2}, j0) \in Game4Eph.s_smap{2} =>
               get_trace (oget Game4Eph.s_smap{2}.[b{2}, j0]) <> get_trace val) Game4Eph.c_smap{2})).
      + rewrite fsetP.
        move => x.
        rewrite !mem_fdom !mem_filter //=.
        move : inv inv2. clear. smt().
  ...
  + if => //.
    + auto => /> &1 &2 str stl 30? inv inv2 *.
      ...
      + move => j bjin H.
        exists j.
        have->: untested_partner_s (oget (get_trace (oget Game4Eph.s_smap{2}.[b{2}, j])))
                 Game4Eph.c_smap{2} = untested_partner_s
                (oget (get_trace (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j]))) Red_Eph.Red_O.c_smap{1}.
        + rewrite /untested_partner_s.
          rewrite /get_partners_s /get_untested_partners_s.
          have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                       get_trace val = Some (oget (get_trace (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j])))) Red_Eph.Red_O.c_smap{1})) = (fdom
      ...
      + rewrite /untested_partner_s.
        ...
        + rewrite fsetP.
          ...
          move : str stl inv inv2. clear. move => *. split; smt().
        smt().
      move : H bjin str stl inv inv2. clear. smt().
...
+ proc; inline.
  ...
  + match Pending_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 30? inv inv2 *.
      ...
      rewrite /get_origins_c /get_tested_origins_c //=.
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => exists (m2o : (pkey * tag) option),
                  get_trace val = Some (pk_e{2}, m2o)) Game4Eph.s_smap{2})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) => exists (m2o : (pkey * tag) option),
                  get_trace val = Some (pk_e{1}, m2o)) Red_Eph.Red_O.s_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: pk_e{1} = pk_e{2} by smt().
        by split; move : inv inv2; clear; smt(). 
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => (exists (m2o : (pkey * tag) option),
                 get_trace val = Some (pk_e{1}, m2o)) /\ get_ir_test val = true) Red_Eph.Red_O.s_smap{1})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) => (exists (m2o : (pkey * tag) option),
                     get_trace val = Some (pk_e{2}, m2o)) /\ get_ir_test val = true) Game4Eph.s_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: pk_e{1} = pk_e{2} by smt().
    ...
    + auto => /> &1 &2 stl str 30? inv inv2 *.
      ...
      have->: (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                exists (m2o : (pkey * tag) option),
                  get_trace val = Some (t{2}.`1, m2o)) Game4Eph.s_smap{2})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                exists (m2o : (pkey * tag) option),
                  get_trace val = Some (t{1}.`1, m2o)) Red_Eph.Red_O.s_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t{1} = t{2} by smt().
      ...
      have->: (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                  ...
                  get_ir_test val = true) Red_Eph.Red_O.s_smap{1})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                  (exists (m2o : (pkey * tag) option),
                     get_trace val = Some (t{2}.`1, m2o)) /\
                  get_ir_test val = true) Game4Eph.s_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t{1} = t{2} by smt().
...
+ proc; inline.
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 30? inv inv2 *.
      rewrite /untested_partner_s.
      rewrite /get_partners_s /get_untested_partners_s.
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t{1}) Red_Eph.Red_O.c_smap{1})) 
                = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t{2}) Game4Eph.c_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t{1} = t{2} by smt().
        by split; move : inv inv2; clear; smt(). 
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t{1} /\ get_ir_test val = false)
               Red_Eph.Red_O.c_smap{1})) = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                   get_trace val = Some t{2} /\ get_ir_test val = false) Game4Eph.c_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t{1} = t{2} by smt().
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 30? inv inv2 *.
      ...
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                get_trace val = Some t'{1}) Red_Eph.Red_O.s_smap{1})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2}) Game4Eph.s_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t'{1} = t'{2} by smt().
        by split; move : inv inv2; clear; smt(). 
      have<-: (fdom (filter (fun (bj : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2} 
                /\ get_ir_test val = false /\ get_ir_sess val = false /\ (get_ir_eph val = false \/
                   get_sr_ltk (oget Game4Eph.servers{2}.[t'{2}.`1.`1]) = false)) Game4Eph.s_smap{2})) = (fdom (filter
              (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{1} 
                /\ get_ir_test val = false /\ get_ir_sess val = false /\ (get_ir_eph val = false \/
      ...
      + rewrite fsetP.
        ...
        do rewrite mem_fdom mem_filter.
        have->: t'{1} = t'{2} by smt().
        by split; move : inv2 inv; clear; smt(). 
      have->: get_ir_sess (oget Red_Eph.Red_O.c_smap{1}.[i{2}]) = get_ir_sess (oget Game4Eph.c_smap{2}.[i{2}]) by smt().
      have->: get_ir_eph (oget Red_Eph.Red_O.c_smap{1}.[i{2}]) = get_ir_eph (oget Game4Eph.c_smap{2}.[i{2}]) by smt().
      smt().
    + rcondf {1} ^if. auto => />.
      rcondf {2} ^if. auto => />.
      sp; if => //.
        ...
        have->: t'{1} = t'{2} by smt(). 
          ...
          + rewrite /get_fresh_partners_c. 
            have->: (fdom (filter(fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2} /\
                  ...
                  get_ir_test val = false /\ get_ir_sess val = false /\ (get_ir_eph val = false \/
                   get_sr_ltk (oget Game4Eph.servers{2}.[t'{2}.`1.`1]) = false)) Red_Eph.Red_O.s_smap{1})). 
            + rewrite fsetP.
              move => x.
              do rewrite mem_fdom mem_filter.
              have->: t'{1} = t'{2} by smt().
              split; move : inv inv2; clear. smt().
            smt().
          have->: t'{1} = t'{2} by smt().
          by move : inv inv2; clear; smt().
        split.
        + move => [].
          + move : inv inv2. clear.
            move => *.
            smt(get_setE mem_set).
          rewrite /get_fresh_partners_c.
          have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2} /\ get_ir_test val = false /\ get_ir_sess val = false 
                     /\ (get_ir_eph val = false \/ get_sr_ltk (oget Game4Eph.servers{2}.[t'{2}.`1.`1]) = false)) Red_Eph.Red_O.s_smap{1})) = (fdom (filter
                (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2} /\ get_ir_test val = false /\ get_ir_sess val = false /\
                  (get_ir_eph val = false \/ get_sr_ltk (oget Game4Eph.servers{2}.[t'{2}.`1.`1]) = false)) Red_Eph.Red_O.s_smap{1})).
          + rewrite fsetP.
            move => x.
            do rewrite mem_fdom mem_filter.
            by split; move : inv inv2; clear; smt().
        ...
        + sp; seq 1 1 : (#pre /\ ={ks}). auto => />.
          ...
          + move => inhq.
            ...
            have := inv6 ((oget t'{2}.`2).`1 ^ st'{2}.`2, st'{2}.`1 ^ st'{2}.`2, st'{2}.`1, g ^ st'{2}.`2, (oget t'{2}.`2).`1) 
                           (oget Red_Eph.Red_O.i_inst{1}.[i{2}]) (oget Red_Eph.Red_O.j_inst{1}.[(pick (get_fresh_partners_c t'{1} Red_Eph.Red_O.s_smap{1} Game4Eph.servers{2}))]) inhq b1 b2 nwin x3ins.
            simplify.
            rewrite !negb_or //=.
            move : np.
            rewrite fcard_eq0 => /mem_pick /mem_fdom.
    ...
    + auto => /> &1 &2 stl str 30? inv inv2 *.
      ...
      have->: (fdom
          (filter
             (fun (_ : int) (val : pr_st_client instance_state) =>
                exists (m2o : (pkey * tag) option),
                  get_trace val = Some (t'{2}.`1, m2o)) Game4Eph.c_smap{2})) = (fdom (filter
             (fun (_ : int) (val : pr_st_client instance_state) =>
                exists (m2o : (pkey * tag) option),
                  get_trace val = Some (t'{1}.`1, m2o)) Red_Eph.Red_O.c_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t'{1} = t'{2} by smt().
      ...
      + rewrite fsetP.
        ...
        have->: t'{1} = t'{2} by smt().
        by split; move : inv inv2; clear; smt().
      have->: get_ir_sess (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j{2}]) = get_ir_sess (oget Game4Eph.s_smap{2}.[b{2}, j{2}]) by smt().
      have->: get_ir_eph (oget Red_Eph.Red_O.s_smap{1}.[b{2}, j{2}]) = get_ir_eph (oget Game4Eph.s_smap{2}.[b{2}, j{2}]) by smt().
      smt().
    rcondf {1} ^if. auto => />.
    rcondf {2} ^if. auto => />. 
    sp; if => //. 
        ...
        ={b0, hm, tested, b_set, x_set, y_set, pk_set, m1_set, m2_set, bad1, bad2, test_ephrev_s, test_ltkrev}(Red_Ltk.Red_O, Game4Ltk)
         ...
         /\ (forall i st t k ir, i \in Game4Ltk.c_smap{2} => Game4Ltk.c_smap{2}.[i] = Some (Accepted_mod st t k ir)
              => t.`1.`2 = g ^ st.`2 /\ t.`1.`2 \in Game4Ltk.m1_set{2} /\ t.`1.`1 = st.`1 /\ st.`1 \in Game4Ltk.servers{2} 
                      ...
                      /\ (oget Red_Ltk.Red_O.b_inst{1}.[st.`1] \in St_CDH_O.cr2{1} <=> get_sr_ltk (oget Red_Ltk.Red_O.servers{1}.[t.`1.`1]))
         ...
         /\ (forall x, x \in Game4Ltk.hq{2} => (x.`3 \in Game4Ltk.pk_set{2} \/ x.`3 \in Game4Ltk.b_set{2}) 
              /\ (x.`4 \in Game4Ltk.m1_set{2} \/ (x.`4 \in Game4Ltk.x_set{2})) /\ (x.`5 \in Game4Ltk.y_set{2} \/ x.`5 \in Game4Ltk.m2_set{2}))
...
auto => />.
split. do split; smt(emptyE mem_empty in_fset0).
move => inv1 inv2 inv3 inv4 inv5 inv6 inv7 inv8 inv9 inv10 inv11 inv12 inv13 inv14 inv15 inv16 inv17 inv18 inv19 inv20 inv21 inv22 inv23 inv24 inv25 inv26 inv27 inv28 inv29 inv30 inv31 inv32 inv33 inv34 inv35 inv36 inv37 inv38 inv39 inv40 inv41 inv42 inv43 inv44 inv45 inv46 inv47 inv48 inv49 inv50 inv51 inv52 inv53 inv54 inv55 inv56 inv57 inv58 inv59 inv60 inv61 inv62 inv63 inv64 inv65 inv66 inv67 inv68 inv69 inv70 rl rr al bl b1l b2l h1l h2l pksl m1l m2l tel tll tl xsl ysl wl ar br b1r b2r bqr h1r h2r hqr pksr m1r m2r tlr tr tqr xsr ysr.
by case : (!ar) => />.
            ...
            + sp; seq 1 1: (#pre /\ ={t}). auto => />.
              ...
              + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
                ...
                + rcondf {1} ^if. auto => /#.
                  ...
                  sp 2 2; if => //. 
                  + auto => /> &1 &2 *. do split; smt(mem_set get_setE in_fsetU1 expgK expM). 
                  auto => /> &1 &2 33? inv *. do split; ~23: smt(mem_set get_setE in_fsetU1 expgK expM).
                  move => i3 st t0 k0 ir.
                  have := inv i3 st t0 k0 ir.
                  smt(get_setE in_fsetU1 mem_set).
                rcondf {1} ^if. auto => /#.
              ...
              sp 1 1; if => //.
              + auto => /> &1 &2 *.
              auto => /> &1 &2 62? c1 *. clear c1.  do split; smt(mem_set get_setE in_fsetU1 expgK expM). 
            sp; seq 1 1: (#pre /\ ={t}). auto => />.
            if => //. auto => /> &1 &2 *. smt(expgK expM).
            + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
              if => //. smt(expgK expM).
          ...
          + sp; seq 1 1: (#pre /\ ={t}). auto => />.
            ...
            + sp 1 1; seq 1 1: (#pre /\ ={k}). auto => />.
              ...
              + rcondf {1} ^if. auto => /#.
                ...
                if => //.
                + auto => /> *. do split; smt(mem_set get_setE expgK expM in_fsetU1).
                auto => /> &1 &2 33? inv *. do split; ~23: smt(mem_set get_setE expgK expM in_fsetU1).
                move => i3 st t0 k0 ir.
                have := inv i3 st t0 k0 ir.
                smt(get_setE in_fsetU1 mem_set).
              rcondf {1} ^if. auto => /#.
              ...
              sp 1 1; if => //.
              + auto => /> &1 &2 *.
              auto => /> &1 &2 31? inv *. do split; ~13: smt(mem_set get_setE in_fsetU1 expgK expM).
              move => i3 st t0 k0 ir.
              have := inv i3 st t0 k0 ir.
              smt(get_setE in_fsetU1 mem_set).
            seq 1 1: (#pre /\ ={k}). auto => />.
...
+ proc; inline.
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 str stl 23? inv inv2 *.
      rewrite /untested_partner_c.
      rewrite /get_partners_c /get_untested_partners_c.
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2}) Game4Ltk.s_smap{2})) 
        = (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{1}) Red_Ltk.Red_O.s_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        move : str stl inv inv2. clear. smt().
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2} /\ get_ir_test val = false) Game4Ltk.s_smap{2})) 
   = (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
               get_trace val = Some t'{1} /\ get_ir_test val = false) Red_Ltk.Red_O.s_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        move : str stl inv inv2. clear. smt().
    ...
    + auto => /> &1 &2 stl str 23? inv inv2 *.
      ...
      + move => + ntpp.
        ...
        + have := ntpp.
          ...
          have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => (exists (m1o : pkey) (m2o : (pkey * tag) option),
                 get_trace val = Some ((b{2}, m1o), m2o)) /\ get_ir_test val = true /\ forall (j0 : int),
                (b{2}, j0) \in Red_Ltk.Red_O.s_smap{1} => get_trace (oget Red_Ltk.Red_O.s_smap{1}.[b{2}, j0]) <>
                get_trace val) Red_Ltk.Red_O.c_smap{1})) = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
             (exists (m1o : pkey) (m2o : (pkey * tag) option), get_trace val = Some ((b{2}, m1o), m2o)) /\ get_ir_test val = true /\
             forall (j0 : int), (b{2}, j0) \in Game4Ltk.s_smap{2} => get_trace (oget Game4Ltk.s_smap{2}.[b{2}, j0]) <> get_trace val) Game4Ltk.c_smap{2})).
          + rewrite fsetP.
            move => x.
            rewrite !mem_fdom !mem_filter //=.
            move : inv inv2. clear. smt().
        ...
        + rewrite fsetP.
          ...
          rewrite !mem_fdom !mem_filter //=.
          move : str stl inv inv2. clear. smt().
        have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some (oget (get_trace (oget Red_Ltk.Red_O.s_smap{1}.[b{2}, j]))) 
                  /\ get_ir_test val = false) Red_Ltk.Red_O.c_smap{1})) = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                     get_trace val = Some (oget (get_trace (oget Game4Ltk.s_smap{2}.[b{2}, j]))) /\ get_ir_test val = false) Game4Ltk.c_smap{2})).
        + rewrite fsetP.
          move => x.
          rewrite !mem_fdom !mem_filter //=.
          move : str stl inv inv2. clear. smt().
...
+ proc; inline.
  ...
  + match Pending_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 23? inv inv2 *.
      ...
      rewrite /get_origins_c /get_tested_origins_c //=.
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => exists (m2o : (pkey * tag) option),
                get_trace val = Some (pk_e{2}, m2o)) Game4Ltk.s_smap{2})) = (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
              exists (m2o : (pkey * tag) option), get_trace val = Some (pk_e{1}, m2o)) Red_Ltk.Red_O.s_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: pk_e{1} = pk_e{2} by smt().
        by split; move : inv inv2; clear; smt(). 
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => (exists (m2o : (pkey * tag) option),
                get_trace val = Some (pk_e{1}, m2o)) /\ get_ir_test val = true) Red_Ltk.Red_O.s_smap{1})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) => (exists (m2o : (pkey * tag) option),
                get_trace val = Some (pk_e{2}, m2o)) /\ get_ir_test val = true) Game4Ltk.s_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: pk_e{1} = pk_e{2} by smt().
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 23? inv inv2 *.
      ...
      have->: (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                exists (m2o : (pkey * tag) option),
                  get_trace val = Some (t{2}.`1, m2o)) Game4Ltk.s_smap{2})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                exists (m2o : (pkey * tag) option),
      ...
      have->: (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                  (exists (m2o : (pkey * tag) option),
                     get_trace val = Some (t{1}.`1, m2o)) /\
                  get_ir_test val = true) Red_Ltk.Red_O.s_smap{1})) = (fdom (filter
             (fun (_ : pkey * int) (val : pr_st_server instance_state) =>
                  (exists (m2o : (pkey * tag) option),
                     get_trace val = Some (t{2}.`1, m2o)) /\
                  get_ir_test val = true) Game4Ltk.s_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t{1} = t{2} by smt().
...
+ proc; inline.
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 22? inv inv2 inv3 *.
      rewrite /untested_partner_s.
      rewrite /get_partners_s /get_untested_partners_s.
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t{1}) Red_Ltk.Red_O.c_smap{1})) 
                 = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t{2}) Game4Ltk.c_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t{1} = t{2} by smt().
        by split; move : inv3 inv2; clear; smt(). 
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => get_trace val = Some t{1} /\ get_ir_test val = false)
               Red_Ltk.Red_O.c_smap{1})) = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                   get_trace val = Some t{2} /\ get_ir_test val = false) Game4Ltk.c_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t{1} = t{2} by smt().
...
+ proc; inline.
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 22? inv inv2 inv3 *.
      rewrite /fresh_partner_c.
      rewrite /get_partners_c /get_fresh_partners_c.
      have->: (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{1}) Red_Ltk.Red_O.s_smap{1})) 
                 = (fdom (filter (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2}) Game4Ltk.s_smap{2})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t'{1} = t'{2} by smt().
      ...
      have<-: (fdom (filter (fun (bj : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{2} 
                /\ get_ir_test val = false /\ get_ir_sess val = false /\ (get_ir_eph val = false \/
                   get_sr_ltk (oget Game4Ltk.servers{2}.[t'{2}.`1.`1]) = false)) Game4Ltk.s_smap{2})) = (fdom (filter
              (fun (_ : pkey * int) (val : pr_st_server instance_state) => get_trace val = Some t'{1} 
                /\ get_ir_test val = false /\ get_ir_sess val = false /\ (get_ir_eph val = false \/
      ...
      + rewrite fsetP.
        ...
        do rewrite mem_fdom mem_filter.
        have->: t'{1} = t'{2} by smt().
        by split; move : inv3 inv2 inv; clear; smt(). 
      have->: get_ir_sess (oget Red_Ltk.Red_O.c_smap{1}.[i{2}]) = get_ir_sess (oget Game4Ltk.c_smap{2}.[i{2}]) by smt().
      have->: get_ir_eph (oget Red_Ltk.Red_O.c_smap{1}.[i{2}]) = get_ir_eph (oget Game4Ltk.c_smap{2}.[i{2}]) by smt().
...
+ proc; inline.
  ...
  + match Accepted_mod {2} ^match. auto => /#.
    ...
    + auto => /> &1 &2 stl str 22? inv inv2 inv3 *.
      ...
      rewrite /get_origins_s /get_fresh_partners_s.
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => exists (m2o : (pkey * tag) option),
                  get_trace val = Some (t'{2}.`1, m2o)) Game4Ltk.c_smap{2})) = (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) =>
                exists (m2o : (pkey * tag) option), get_trace val = Some (t'{1}.`1, m2o)) Red_Ltk.Red_O.c_smap{1})).
      + rewrite fsetP.
        move => x.
        do rewrite mem_fdom mem_filter.
        have->: t'{1} = t'{2} by smt().
        by split; move : inv inv2 inv3; clear; smt().
      have->: (fdom (filter (fun (_ : int) (val : pr_st_client instance_state) => (exists (m2o : (pkey * tag) option), get_trace val = Some (t'{1}.`1, m2o)) 
                 /\ get_ir_test val = false /\ get_ir_sess val = false /\ get_ir_eph val = false) Red_Ltk.Red_O.c_smap{1})) = (fdom
            (filter (fun (_ : int) (val : pr_st_client instance_state) => (exists (m2o : (pkey * tag) option), get_trace val = Some (t'{2}.`1, m2o)) 
      ...
      + rewrite fsetP.
        ...
        have->: t'{1} = t'{2} by smt().
        by split; move : inv inv2 inv3; clear; smt().
      have->: get_ir_sess (oget Red_Ltk.Red_O.s_smap{1}.[b{2}, j{2}]) = get_ir_sess (oget Game4Ltk.s_smap{2}.[b{2}, j{2}]) by smt().
      have->: get_ir_eph (oget Red_Ltk.Red_O.s_smap{1}.[b{2}, j{2}]) = get_ir_eph (oget Game4Ltk.s_smap{2}.[b{2}, j{2}]) by smt().
      have->: get_sr_ltk (oget Red_Ltk.Red_O.servers{1}.[b{2}]) = get_sr_ltk (oget Game4Ltk.servers{2}.[b{2}]). 
      + move : inv. clear. smt().
      smt().
    rcondf {1} ^if. auto => />.
